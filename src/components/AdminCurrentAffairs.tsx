        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden divide-y divide-slate-50">
          {posts.map(post => (
            <div key={post.id} className="flex items-center gap-3 px-4 py-3.5 hover:bg-slate-50 transition-colors group">
              ...
              {post.date && (
                <span className="text-xs text-slate-400 font-medium shrink-0 hidden sm:block">{post.date}</span>
              )}
                    ...
                    {categories.length === 0 ? (
                      ...
                      <>
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-orange-50 transition-colors text-left border-t border-slate-100 mt-1"
                        >
                          <div className="w-7 h-7 rounded-lg bg-orange-100 flex items-center justify-center shrink-0">
                            <Plus className="w-4 h-4 text-orange-600" />
                          </div>
                          <span className="text-sm font-bold text-orange-600">Add New Category</span>
                        </button>
                      </>
                    )}
