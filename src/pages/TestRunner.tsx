          ...
          <main className="flex-1 overflow-y-auto p-4 md:p-8 bg-[#f8f9fa]">
            <div className="max-w-4xl mx-auto space-y-8 pb-20">
              {questions.map((q, idx) => {
                ...
                return (
                  <div key={q.id} className={`bg-white rounded-[40px] border shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500 ${isCorrect ? 'border-emerald-100' : isUnattempted ? 'border-slate-100' : 'border-rose-100'}`} style={{ animationDelay: `${idx * 50}ms` }}>
                    <div className="p-8 md:p-10">
                      <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center gap-3">
                          <span className="w-10 h-10 bg-slate-900 text-white rounded-xl flex items-center justify-center text-sm font-black shadow-lg">
                            {idx + 1}
                          </span>
                      ...
                      <h3 className="text-xl font-bold text-slate-800 mb-10 leading-relaxed px-2">
                        {q.questionText}
                      </h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {q.options.map((opt: string, i: number) => {
                          ...
                          return (
                            <div 
                              key={i}
                              className={`flex items-center p-5 rounded-2xl border-2 transition-all relative
